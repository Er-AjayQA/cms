...
export const SuperadminSubscriptionPlanForm = () => {
  const { formik, activeView, closeForm, billingCycleOptions } =
    useSuperadminSubscription();

  const isReadOnly = activeView === "view" ? true : false;
    ...
    <section className="space-y-6">
      ...
      <form className="space-y-4" onSubmit={formik.handleSubmit}>
        ...
        <div className="flex justify-end gap-3">
          ...
          {activeView !== "view" && (
            <Button type="submit">
              {activeView === "edit" ? "Update Plan" : "Create Plan"}
            </Button>
          )}
        </div>
      </form>
